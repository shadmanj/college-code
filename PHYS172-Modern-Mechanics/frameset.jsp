...
<html  lang="en-US-purdue"> 
 <head>
  ...
  <meta name="copyright" content="&copy; 1997-2013 Blackboard Inc. All Rights Reserved. U.S. Patent No. 7,493,396 and 7,558,853. Additional Patents Pending.">
  <meta name="keywords" content="Blackboard">
  <meta http-equiv="Pragma" content="no-cache">
  <meta http-equiv="Expires" content="-1">
  <link rel="SHORTCUT ICON" type="image/x-icon" href="/ui/bb-icon2.ico">
      <link rel="stylesheet" type="text/css" media="print" href="/ui/styles/print.css?v=9.1.90132.0-4">
    <script type="text/javascript" src="/javascript/i18n.js?v=9.1.90132.0-4"></script>
...
_init_bundle_LOCALE_SETTINGS();
         ...
         <script type="text/javascript" src="/javascript/prototype.js?v=9.1.90132.0-4"></script>
    <script type="text/javascript" src="/javascript/fastinit.js?v=9.1.90132.0-4"></script>
    <script type="text/javascript" src="/javascript/ngui/page.js?v=9.1.90132.0-4"></script>
    <script type="text/javascript" src="/javascript/date.js?v=9.1.90132.0-4"></script>
    <script type="text/javascript" src="/webapps/gradebook/js/gradebookgrid_base.js?v=9.1.90132.0-4"></script>
    <script type="text/javascript" src="/webapps/gradebook/js/gradebookgridmodel.js?v=9.1.90132.0-4"></script>
    <script type="text/javascript" src="/webapps/gradebook/js/gradebookgridmodel_loader.js?v=9.1.90132.0-4"></script>
    <script type="text/javascript" src="/webapps/gradebook/js/gradebookgridmodel_col.js?v=9.1.90132.0-4"></script>
    <script type="text/javascript" src="/webapps/gradebook/js/gradebookgridmodel_cell.js?v=9.1.90132.0-4"></script>
    <script type="text/javascript" src="/webapps/gradebook/js/gradebookgridmodel_schema.js?v=9.1.90132.0-4"></script>
    <script type="text/javascript" src="/webapps/gradebook/js/gradebookgridmodel_customview.js?v=9.1.90132.0-4"></script>
    <script type="text/javascript" src="/webapps/portal/frameset.js?v=9.1.90132.0-4"></script>
    <script type="text/javascript" src="/javascript/browserSpecificBehavior.js?v=9.1.90132.0-4"></script>
           <script type="text/javascript">page.bundle.addKey('lightbox.loading','Loading...');page.bundle.addKey('validation.date_past','The end date cannot be earlier than the start date.');page.bundle.addKey('frameset.contentframe.title','Content');page.bundle.addKey('inlineconfirmation.close','Close');page.bundle.addKey('yt.paused','Paused:');page.bundle.addKey('yt.buffering','Buffering:');page.bundle.addKey('lightbox.overlay','Lightbox will have a overlay.');page.bundle.addKey('inlineconfirmation.refresh','Refresh');page.bundle.addKey('yt.ended','Ended:');page.bundle.addKey('yt.playing','Playing:');page.bundle.addKey('yt.play','Play');page.bundle.addKey('yt.unmute','Unmute');page.bundle.addKey('hidden.link.close.form','End of form. Click to return to associated item.');page.bundle.addKey('yt.cued','Cued:');page.bundle.addKey('hidden.link.close.menu','End of menu. Click to return to associated item.');page.bundle.addKey('yt.stopped','Stopped:');page.bundle.addKey('contextmenu.frame.title','Menu frame');page.bundle.addKey('yt.mute','Mute');page.bundle.addKey('number_format.decimal_point','.');page.bundle.addKey('yt.pause','Pause');</script>
 ...
 <frame src="/webapps/portal/execute/topframe?tab_tab_group_id=_17_1&frameSize=LARGE" name="nav" scrolling="auto" title="Blackboard Learn: Header" />
 <frame src="/webapps/blackboard/execute/content/file?cmd=view&content_id=_1175704_1&course_id=_56029_1&framesetWrapped=true" name="content" scrolling="auto" title="Content" target="_self" />
<noframes>
        <h1>Frameset Overview</h1>
        <p>The Blackboard Learn environment includes a header frame with images and buttons customized by the institution and tabs that navigate to different areas within Blackboard Learn. Clicking on a tab will open that area in the content frame. Web pages containing specific content, features, functions, and tools are accessed from the tab areas.</p>
        <h2>Blackboard Learn: Header</h2>
        <p>The <a href="/webapps/portal/execute/topframe?tab_tab_group_id=_17_1&frameSize=LARGE">Blackboard Learn: Header</a> contains a customizable institution image and navigation buttons that allow the user to access the institution home page, access Blackboard Learn help, and logout of Blackboard Learn. It also contains tabs that navigate to different areas within Blackboard Learn.</p>
        <h2>Content</h2>
        <p>The <a href="/webapps/blackboard/execute/content/file?cmd=view&content_id=_1175704_1&course_id=_56029_1&framesetWrapped=true">Content</a> always contains one of the following pages:</p>
        <strong>Tab area</strong>
        ...
        <h2>Help</h2>
        <p>Detailed help documentation explaining this frameset may be found at <a href="http://www.blackboard.com/docs/documentation.htm?DocID=19109003@X@user.locale@X@">http://www.blackboard.com/docs/documentation.htm?DocID=19109003@X@user.locale@X@</a>.</p>
      </noframes>
     </frameset>
