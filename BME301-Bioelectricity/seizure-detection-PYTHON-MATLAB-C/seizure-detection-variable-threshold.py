# This code detects seizures in mice based on a variable threshold system.
# The program takes an array of any size as input, then splits it into 175 
# Data point "windows". An average and standard deviation value is calculated
# For each window. Seizures are "detected" when multiple data points exceed
# The threshold which is a multiple of the standard deviation of data points
# in a window.
