# This script is designed to detect seizures from EEG data using a variable
# threshold. Data is divided into "windows" of 175 data points. Average annd
# standard deviation is calculated, with the threshold being a factor of the 
# standard deviation varying from the average. Data points that are over the
# threshold are flagged as seizures. 
